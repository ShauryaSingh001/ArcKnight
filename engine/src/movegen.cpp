...
void generate_pseudo_legal(const Board& board, MoveList& list) {
    ...
    if (us == WHITE) {
        ...
        // 2. Double Pushes (Only valid if single push was valid AND pawn is on rank 3 after first push)
        ...
        // 3. Captures Right (Shift Up-Right 9)
        ...
        // 4. Captures Left (Shift Up-Left 7)
